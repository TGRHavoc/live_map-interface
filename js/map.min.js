...
var u=convertToMapGMAP(o.position.x,o.position.y),A=o.type,k='<div class="row info-body-row"><strong>Position:</strong>&nbsp;X {'+o.position.x.toFixed(4)+"} Y {"+o.position.y.toFixed(4)+"} Z {"+o.position.z.toFixed(4)+"}</div>"
""!=o.hash&&(k+='<div class="row info-body-row"><strong>Hash:</strong>&nbsp;'+o.hash+"</div>"),""!=o.modelname&&(k+='<div class="row info-body-row"><strong>Model Name:</strong>&nbsp;'+o.modelname+"</div>"),""!=o.description&&(k+='<div class="row info-body-row"><strong>Description:</strong>&nbsp;'+o.description+"</div>")
var w='<div class="info-window"><div class="info-header-box"><div class="info-header">'+M+'</div></div><div class="clear"></div><div id=info-body>'+k+"</div></div>",P=new google.maps.InfoWindow({content:w}),y={url:_MAP_iconURL+A.icon,size:A.size,origin:A.origin,scaledSize:void 0==A.scaledSize?A.size:A.scaledSize,anchor:A.anchor},f=new google.maps.Marker({id:_MAP_markerStore.length,type:A.name,position:u,icon:y,map:map,popup:P,object:o,draggable:!!a,animation:e?google.maps.Animation.DROP:0})
return google.maps.event.addListener(f,"click",function(){_MAP_currentMarker&&_MAP_currentMarker.popup.close(),_MAP_currentMarker=f,f.popup.open(map,this)}),google.maps.event.addListener(f,"drag",function(){var e=convertToGame(f.position.lat(),f.position.lng())
o.position.x=e.x,o.position.y=e.y,"@DEBUG@@Locator"==o.reference&&($("#locator_x").val(e.x),$("#locator_y").val(e.y))}),"@DEBUG@@Locator"==M?$("#marker-list").append('<div id="marker_'+f.id+'" data-id="'+f.id+'" class="marker-item"><div class="marker-desc"><span class="marker_name">@Locator</span></div><div class="marker-options"><a href="#" class="marker_view" title="View"><img src="images/icons/view.png" alt="View" height="16" width="16" /></a> </div></div><div class="clear"></div>'):$("#marker-list").append('<div id="marker_'+f.id+'" data-id="'+f.id+'" class="marker-item"><div class="marker-desc"><span class="marker_name">'+M+'</span></div><div class="marker-options"><a href="#" class="marker_view" title="View"><img src="images/icons/view.png" alt="View" height="16" width="16" /></a> / <a href="#" class="marker_delete" title="Delete"><img src="images/icons/delete.png" alt="Delete" height="16" width="16" /></a></div></div><div class="clear"></div>'),_MAP_markerStore.push(f),_MAP_markerStore.length}function setMapCenter(e,a){map.setCenter(new google.maps.LatLng(e,a)),map.setZoom(6)}function setMapCenterGMAP(e){map.setCenter(e),map.setZoom(6)}function clearAllMarkers(){for(var e=0;e<_MAP_markerStore.length;e++)"NULL"!=_MAP_markerStore[e]&&_MAP_markerStore[e].setMap(null)
_MAP_markerStore.length=0}function clearMarker(e){"NULL"!=_MAP_markerStore[e]&&(_MAP_markerStore[e].setMap(null),_MAP_markerStore[e]="NULL",$("#marker_"+e).remove())}function getMarker(e){if("NULL"!=_MAP_markerStore[e])return _MAP_markerStore[e]}var _MAP_currentMarker,_MAP_markerStore,bounds={3:2,4:5,5:10,6:21,7:42},mapAtlasOptions={getTileUrl:function(e,a){var o=getNormalizedCoord(e,a)
