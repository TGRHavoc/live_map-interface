...
class Translator {
    ...
    getValueFromJSON(key) {
        return key
            .split(".")
            .reduce((obj, i) => (obj ? obj[i] : null), this.translations);
    }
    ...
    ${element.outerHTML}`);
        ...
        keys.forEach((key, index) => {
            ...
            if (text) {
                ...
                console.warn(
                    `No translation found for key "${key}" in language "${this._lang}". Is there a key/value in your translation file?`
                );
            }
        });
    }
