...
class VersionCheck {
    ...
    async getCurrentVersion() {
        ...
        try {
            ...
            new Alerter({
                status: "error",
                text: lang.t("errors.version-check.current.message", {
                    error: error,
                }),
    ...
    async getRemoteVersion() {
        ...
        try {
            ...
            new Alerter({
                status: "error",
                text: lang.t("errors.version-check.remote.message", {
                    error: err,
                }),
